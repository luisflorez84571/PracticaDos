        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AreaInteres = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sesiones = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Ponentes = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Temas = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Programaciones_Eventos_EventoId",
                        column: x => x.EventoId,
